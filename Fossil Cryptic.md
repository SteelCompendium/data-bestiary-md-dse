...
- name: Solo Monster
  effect: '- **Solo Turns**: The cryptic takes two turns each round. They can use
    ...
    While dazed, the cryptic can take one action and one maneuver per turn. - **End
    Effect**: At the end of their turn, the cryptic can take 5 damage to end one save
...
- name: Seismic Step
  effect: The cryptic ignores difficult terrain. Additionally, they have line of effect
...
- name: Shatterstone
  ...
  effects:
  - name: Effect
    effect: The cryptic burrows up to half their speed, then creates the burst when
