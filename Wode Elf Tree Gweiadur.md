...
traits:
- name: Masking Glamor
  effect: The tree gweiadur immediately hides at the end of their turn while in cover
...
- name: Snare Bow
  ...
  - name: Effect
    effect: 'The tree gweiadur can shift 3 after making the attack. 3 Malice: If this
      attack restrains the target, an enemy within 1 of the target is also restrained
      (save ends). '
