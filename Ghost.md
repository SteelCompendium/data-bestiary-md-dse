...
- name: Heat Death
  ...
  t1: 2 cold damage; P2 slowed (save ends)
  t2: 5 cold damage; P3 slowed (save ends)
  t3: 6 cold damage; P2 slowed (save ends)
  effects:
  - roll: 2d10 + 3
    t1: 2 cold damage; P2 slowed (save ends)
    t2: 5 cold damage; P3 slowed (save ends)
...
- name: Shriek
  ...
  effects:
  - name: Effect
    effect: 'The ghost has resistance against the attack, and the target takes 2 sonic
      damage. '
