...
- name: Violent Thrashing
  ...
  - roll: 2d10 + 2
    ...
    t3: '12 damage; one target is pushed 2 and prone; other target is vertically pushed
      3 '
- name: Bound Ahead
  type: Action
  cost: 5 Malice
  ...
  effects:
  - name: Effect
    effect: 'The [[Griffon|griffon]] shifts up to their speed in a straight line. Each enemy within
      their reach during this movement can choose to either take 5 damage or be knocked
      prone. '
- name: Wing Buffet
  type: Maneuver
  cost: 3 Malice
