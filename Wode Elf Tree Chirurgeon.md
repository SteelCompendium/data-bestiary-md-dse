...
traits:
- name: Masking Glamor
  effect: The tree chirurgeon immediately hides at the end of their turn while in
...
- name: Wild Axe
  ...
  effects:
  - name: Effect
    effect: 'The tree chirurgeon can make a ranged free strike before attacking. 5
