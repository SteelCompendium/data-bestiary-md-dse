...
- name: Hunter’s Glamor
  effect: The tree guerilla immediately hides at the end of their turn, even if they
    are observed.
abilities:
- name: Splinter Dagger
  ...
  effects:
  - name: Effect
    effect: 'The tree guerilla can teleport 3 after making the attack. 5 Malice: The
