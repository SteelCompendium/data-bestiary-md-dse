...
- name: Mobile Prison Harness
  effect: Slowed or restrained creatures adjacent to the battle walker become restrained
    (save ends) and have a bane on their resistance rolls. Adjacent restrained creatures
...
- name: Grasping Claws
  ...
  t1: 4 damage; M1 slowed (save ends)
  t2: 7 damage; M2 slowed (save ends)
...
- name: Stunning Blast
  ...
  t1: 2 lightning damage; A1 slowed (save ends)
  t2: 3 lightning damage; A2 slowed (save ends)
  t3: '5 lightning damage; A3 slowed (save ends) '
  effects:
  - roll: 2d10 + 2
    t1: 2 lightning damage; A1 slowed (save ends)
    t2: 3 lightning damage; A2 slowed (save ends)
