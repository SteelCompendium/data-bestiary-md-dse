...
- name: Solo Monster
  effect: '- **Solo Turns:** The chimera takes 2 turns each round. They can use two
    ...
    choose. While dazed, the chimera can take one action and one maneuver per turn.  **End
...
- name: Chorus of Destruction
  ...
  - name: Effect
    effect: The chimera uses Roar. The chimera then shifts their speed and can make
      a free strike against each enemy who comes within 1 of them during the move.
